...
import CompanyAdd from "../components/auth/CompanyAdd";
        ...
        <main className="flex-1 p-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-2 mb-4">
            <div className="flex gap-2">
              <button
                onClick={handleOpen}
                className="bg-red-500 text-white px-4 py-2 rounded transition-transform duration-900"
              >
                + Add Company
              </button>
            </div>
        ...
        {isViewOpen && selectedCompany && (
          <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded shadow w-96">
              ...
              <p>
                <strong>Package:</strong> {selectedCompany.package}
              </p>
              <p>
                <strong>Registered:</strong> {selectedCompany.registered}
              </p>
              <p>
                <strong>Employees:</strong> {selectedCompany.employees}
              </p>
              <p>
                <strong>Clients:</strong> {selectedCompany.clients}
              </p>
              <p>
                <strong>Users:</strong> {selectedCompany.users}
              </p>
              <p>
