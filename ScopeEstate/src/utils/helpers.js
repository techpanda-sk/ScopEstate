...
const CreatePackageForm = () => {
  ...
  const modulesList = [
    ...
    'Invoices', 'Payments', 'Time Logs', 'Tickets', 'Events', 'Notices',
    'Leaves', 'Leads', 'Holidays', 'Products', 'Expenses', 'Contracts',
    'Reports', 'Orders', 'Knowledge Base', 'Bank Account', 'Messages', 'Assets',
    'Zoom', 'Recruit', 'Payroll', 'Purchase', 'Letter', 'QR Code', 'Biolinks', 'Performance'
  ];
  ...
  const selectAllModules = () => {
    setFormData(prev => ({
      ...prev,
      selectedModules: prev.selectedModules.length === modulesList.length ? [] : [...modulesList]
    }));
  };
  ...
  <div className=" relative">
      ...
      <button
        ...
        className="absolute left-36 rounded-l-full top-6 w-15 h-10  bg-red-500 text-white flex items-center justify-center shadow-lg hover:bg-red-600 z-10"
      >
        &times;
      </button>

      {/* <div className="relative left-19 max-w-6xl mx-auto "> */}
        <div className="relative left-19 max-w-6xl mx-auto  bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="p-6">
